...
), En = L(/^(?:\w+script|data):/i), gn = L(
  /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g
  // eslint-disable-line no-control-regex
), xt = L(/^html$/i), hn = L(/^[a-z][.\w]*(-[.\w]+)+$/i);
...
function Pt() {
  let r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _n();
  const t = (a) => Pt(a);
  ...
  let et = !0, De = !0, tt = !1, nt = !0, V = !1, Te = !0, W = !1, Ne = !1, we = !1, j = !1, Ee = !1, ge = !1, ot = !0, it = !1;
  ...
  let xe = null;
  const lt = c({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), he = "http://www.w3.org/1998/Math/MathML", _e = "http://www.w3.org/2000/svg", x = "http://www.w3.org/1999/xhtml";
  let Q = x, Pe = !1, ke = null;
  const Kt = c({}, [he, _e, x], ze);
  ...
  const Vt = i.createElement("form"), ct = function(e) {
    ...
    return ke[e.namespaceURI] ? e.namespaceURI === _e ? n.namespaceURI === x ? o === "svg" : n.namespaceURI === he ? o === "svg" && (f === "annotation-xml" || Ae[f]) : !!ut[o] : e.namespaceURI === he ? n.namespaceURI === x ? o === "math" : n.namespaceURI === _e ? o === "math" && Se[f] : !!ft[o] : e.namespaceURI === x ? n.namespaceURI === _e && !Se[f] || n.namespaceURI === he && !Ae[f] ? !1 : !ft[o] && (Zt[o] || !ut[o]) : !!(le === "application/xhtml+xml" && ke[e.namespaceURI]) : !1;
  }, D = function(e) {
    ce(t.removed, {
      element: e
    });
    ...
    return e && o && _.insertBefore(i.createTextNode(o), _.childNodes[0] || null), Q === x ? Ft.call(n, W ? "html" : "body")[0] : W ? n.documentElement : _;
  }, dt = function(e) {
    return kt.call(
      e.ownerDocument || e,
      e,
  ...
  const Tt = function(e) {
    ...
    if (!($.tagCheck instanceof Function && $.tagCheck(o)) && (!T[o] || ae[o])) {
      if (!ae[o] && gt(o) && (m.tagNameCheck instanceof RegExp && S(m.tagNameCheck, o) || m.tagNameCheck instanceof Function && m.tagNameCheck(o)))
        return !1;
      if (ve && !J[o]) {
        const f = C(e) || e.parentNode, _ = w(e) || e.childNodes;
        if (_ && f) {
          const d = _.length;
          for (let R = d - 1; R >= 0; --R) {
            const k = re(_[R], !0);
        ...
        if (!($.attributeCheck instanceof Function && $.attributeCheck(n, e))) {
          if (!g[n] || Ce[n]) {
            if (
              ...
              !(gt(e) && (m.tagNameCheck instanceof RegExp && S(m.tagNameCheck, e) || m.tagNameCheck instanceof Function && m.tagNameCheck(e)) && (m.attributeNameCheck instanceof RegExp && S(m.attributeNameCheck, n) || m.attributeNameCheck instanceof Function && m.attributeNameCheck(n, e)) || // Alternative, second condition checks if it's an `is`-attribute, AND
    ...
    for (; f--; ) {
      ...
      let h = d === "value" ? Ge : an(Ge);
      if (o.attrName = te, o.attrValue = h, o.keepAttr = !0, o.forceKeepAttr = void 0, P(A.uponSanitizeAttribute, e, o), h = o.attrValue, it && (te === "id" || te === "name") && (Y(d, e), h = Yt + h), Te && S(/((--!?|])>)|<\/(style|title|textarea)/i, h)) {
        Y(d, e);
        continue;
      }
      if (te === "attributename" && He(h, "href")) {
        Y(d, e);
        continue;
      }
      if (o.forceKeepAttr)
      ...
      const _t = E(e.nodeName);
      if (!Et(_t, te, h)) {
        Y(d, e);
        continue;
      }
      if (p && typeof F == "object" && typeof F.getAttributeType == "function" && !R)
        switch (F.getAttributeType(_t, te)) {
          case "TrustedHTML": {
            h = p.createHTML(h);
            break;
          }
          case "TrustedScriptURL": {
            h = p.createScriptURL(h);
            break;
          }
        }
      if (h !== Ge)
        try {
          R ? e.setAttributeNS(R, d, h) : e.setAttribute(d, h), Fe(e) ? D(e) : yt(t.removed);
        } catch {
          Y(d, e);
        }
    }
    ...
    for (P(A.beforeSanitizeShadowDOM, e, null); n = o.nextNode(); )
      P(A.uponSanitizeShadowNode, n, null), Tt(n), ht(n), n.content instanceof u && a(n.content);
    P(A.afterSanitizeShadowDOM, e, null);
  };
  return t.sanitize = function(a) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = null, o = null, f = null, _ = null;
    ...
    const d = dt(se ? a : n);
    for (; f = d.nextNode(); )
      Tt(f), ht(f), f.content instanceof u && qt(f.content);
    if (se)
      return a;
    if (j) {
      if (Ee)
        for (_ = Ut.call(n.ownerDocument); n.firstChild; )
          _.appendChild(n.firstChild);
      else
        _ = n;
      return (g.shadowroot || g.shadowrootmode) && (_ = Gt.call(s, _, !0)), _;
    }
